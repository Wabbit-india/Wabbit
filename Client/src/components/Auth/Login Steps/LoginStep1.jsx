  ...
  return (
    <div className="flex flex-col  gap-3 h-[100%]">
      ...
      <div className="h-[85%] flex flex-col gap-3">
        ...
        <div className="py-3 text-center w-full cursor-pointer border rounded-xl border-[rgb(0,0,0,0.2)] font-bold flex-row flex items-center justify-center gap-[5%] bg-black">
